    ...
    >
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-md shadow-sm">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div
            className={`flex md:hidden items-center justify-center w-9 h-9 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-sm ${shouldStartTransparent && !scrolled ? "border border-white/30" : ""}`}
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
          ...
          <li className="mb-5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                aria-label="Toggle vehicle models submenu"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
